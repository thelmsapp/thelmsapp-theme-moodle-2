 ...
 * @return string
 */
function thelmsapp_user_settings($css, $theme) {
    ...
    $css = thelmsapp_set_fontsizereference($css, $fontsizereference);
    ...
    $css = thelmsapp_set_framemargin($css, $framemargin);
    ...
    $css = thelmsapp_set_headerbgc($css, $headerbgc);
    ...
    $css = thelmsapp_set_blockcontentbgc($css, $blockcontentbgc);
    ...
    $css = thelmsapp_set_lblockcolumnbgc($css, $lblockcolumnbgc);
    ...
    $css = thelmsapp_set_rblockcolumnbgc($css, $rblockcolumnbgc);
    ...
    $css = thelmsapp_set_blockcolumnwidth($css, $blockcolumnwidth);
    ...
    $css = thelmsapp_set_blockpadding($css, $blockcolumnwidth, $blockpadding);
    ...
    $css = thelmsapp_set_customcss($css, $customcss);
 ...
 *
 */
function thelmsapp_set_fontsizereference($css, $fontsizereference) {
    $tag = '[[setting:fontsizereference]]';
    $css = str_replace($tag, $fontsizereference.'px', $css);
    return $css;
}

function thelmsapp_set_framemargin($css, $framemargin) {
...
function thelmsapp_set_headerbgc($css, $headerbgc) {
    $tag = '[[setting:headerbgc]]';
    $css = str_replace($tag, $headerbgc, $css);
    return $css;
}

function thelmsapp_set_blockcontentbgc($css, $blockcontentbgc) {
    $tag = '[[setting:blockcontentbgc]]';
    $css = str_replace($tag, $blockcontentbgc, $css);
    return $css;
}

function thelmsapp_set_lblockcolumnbgc($css, $lblockcolumnbgc) {
    $tag = '[[setting:lblockcolumnbgc]]';
    $css = str_replace($tag, $lblockcolumnbgc, $css);
    return $css;
}

function thelmsapp_set_rblockcolumnbgc($css, $rblockcolumnbgc) {
    $tag = '[[setting:rblockcolumnbgc]]';
    $css = str_replace($tag, $rblockcolumnbgc, $css);
    return $css;
}

function thelmsapp_set_blockcolumnwidth($css, $blockcolumnwidth) {
...
function thelmsapp_set_blockpadding($css, $blockcolumnwidth, $blockpadding) {
...
function thelmsapp_set_customcss($css, $customcss) {
